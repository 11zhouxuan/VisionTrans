...
const translations = {
  zh: {
    ...
    'api.extraParams': '额外参数',
    'api.extraParamsPlaceholder': '如 {"temperature": 0.7, "top_p": 0.9}',
    'api.extraParamsHint': 'JSON 格式，可配置 temperature、top_p、max_tokens 等参数',
    'api.extraParamsError': 'JSON 格式错误',
  ...
  en: {
    ...
    'api.extraParams': 'Extra Parameters',
    'api.extraParamsPlaceholder': 'e.g. {"temperature": 0.7, "top_p": 0.9}',
    'api.extraParamsHint': 'JSON format. Configure temperature, top_p, max_tokens, etc.',
    'api.extraParamsError': 'Invalid JSON format',
