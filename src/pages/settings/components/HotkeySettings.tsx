...
export default function HotkeySettings({ hotkey, onHotkeyChange }: HotkeySettingsProps) {
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-sm font-semibold text-gray-700">快捷键设置</h3>

      <div>
        <label className="block text-xs text-gray-500 mb-1">全局快捷键</label>
        <div
        ...
        >
          ...
          <span className="text-sm text-gray-700">
            {recording
              ? (tempKeys.length > 0 ? tempKeys.join(' + ') : '请按下快捷键组合...')
              : hotkey
            }
          </span>
        </div>
